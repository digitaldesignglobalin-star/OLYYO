          ...
          {restaurants.map((restaurant, index) => (
            ...
            >
              <div className="relative overflow-hidden group">
                ...
                {restaurant.trending && (
                  <div
                    className="absolute top-4 left-4 bg-gradient-to-r from-orange-500 to-red-500 text-white 
                ...
                {/* Delivery Time */}
                <div
                  className="absolute bottom-10 left-1 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full 
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <h3
                    className="text-xl font-bold text-gray-800 group-hover:text-orange-600 
                               transition-colors duration-300"
                  >
                    {restaurant.name}
                  </h3>
                  <div
                    className="flex items-center bg-orange-50 px-2 py-1 rounded group 
                                hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 
                                transition-all duration-300"
                  >
                    <Star
                      className="w-4 h-4 text-orange-500 fill-current group-hover:text-white 
                                   transition-colors duration-300"
                    />
                ...
                >
                  ...
                  <ChevronRight
                    className="w-4 h-4 ml-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-2 
                                         transition-all duration-300"
                  />
                </button>
              </div>
