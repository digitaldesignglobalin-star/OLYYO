...
const popularFoods = [
  {
    ...
    rating: 4.8,
    image: "https://plus.unsplash.com/premium_photo-1695758787947-0aff87c1f93a?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    id: 2,
    ...
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center animate-slide-up">
          Trending Dishes
          <div
            className="w-24 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-2 rounded-full 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {popularFoods.map((food, index) => (
            ...
            >
              {/* Food Image */}
              <div className="relative h-40 overflow-hidden rounded-xl mb-4 group-hover:scale-105 transition-transform duration-500">
                <Image
                  src={food.image}
                  alt={food.name}
                  fill
              ...
              <div className="flex justify-between items-start mb-2">
                <h3
                  className="text-lg font-bold text-gray-800 group-hover:text-orange-600 
                ...
                <div className="flex items-center group cursor-default">
                  <Star
                    className="w-4 h-4 text-orange-500 fill-current group-hover:scale-125 
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <span
                    className="text-xl font-bold text-orange-600 group-hover:scale-110 
                                 transition-transform duration-300"
                  >
                    {food.price}
                  </span>
                  {cartItems[food.id] > 0 && (
                    <span
                      className="ml-2 text-xs bg-green-100 text-green-600 px-2 py-1 rounded-full 
                                   animate-scale"
                    >
                      +{cartItems[food.id]}
                    </span>
                ...
                >
                  ...
                  Add
                  <Plus
                    className="w-3 h-3 ml-1 opacity-0 group-hover:opacity-100 group-hover:scale-125 
