      ...
      <div className="relative z-10 w-full max-w-[420px] px-4">
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[35px] p-8 pt-16 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 w-10 flex items-center justify-center border-r border-white/10">
                <Mail size={18} className="text-gray-500 group-focus-within:text-emerald-400" />
              </div>
              <input
                type="text"
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 w-10 flex items-center justify-center border-r border-white/10">
                <Lock size={18} className="text-gray-500 group-focus-within:text-emerald-400" />
              </div>
              <input
          ...
          <p className="mt-8 text-center text-gray-400 text-xs">
            ...
            <Link href="/middleman/register" className="text-emerald-500 font-bold hover:underline ml-1">
              Register Hub
            </Link>
          </p>
        </div>
