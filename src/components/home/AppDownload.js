...
const bgElements = [
  { top: '12%', left: '85%', delay: '0s', duration: '3.5s' },
  { top: '45%', left: '15%', delay: '0.5s', duration: '4.2s' },
  { top: '78%', left: '60%', delay: '1s', duration: '3.8s' },
  { top: '23%', left: '40%', delay: '1.5s', duration: '4.5s' },
  { top: '67%', left: '90%', delay: '2s', duration: '3.2s' },
  { top: '89%', left: '10%', delay: '2.5s', duration: '4.8s' },
  { top: '34%', left: '72%', delay: '3s', duration: '3.9s' },
  { top: '56%', left: '53%', delay: '3.5s', duration: '4.1s' },
  { top: '92%', left: '80%', delay: '4s', duration: '3.6s' },
  { top: '15%', left: '28%', delay: '4.5s', duration: '4.4s' },
];
